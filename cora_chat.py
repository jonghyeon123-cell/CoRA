...
QUERY_ALIASES = {
    ...
    "웹": ["웹", "웹프로그래밍", "소프트웨어", "프론트엔드", "백엔드", "JavaScript", "HTML", "CSS", "React"],
    "웹개발": ["웹", "웹프로그래밍", "소프트웨어", "프론트엔드", "백엔드", "JavaScript", "HTML", "CSS", "React"],
    "개발자": ["소프트웨어", "프로그래밍", "자료구조", "알고리즘", "데이터베이스", "운영체제"],
    "프론트엔드": ["프론트엔드", "웹", "HTML", "CSS", "JavaScript", "React"],
    "풀스택": ["풀스택", "웹", "프론트엔드", "백엔드", "데이터베이스", "소프트웨어"],
    "앱": ["앱", "모바일", "소프트웨어", "프로그래밍"],
    "모바일": ["모바일", "앱", "소프트웨어", "프로그래밍"],
...
TRACK_KEYWORD_GROUPS = {
    ...
    "소프트웨어": ["소프트웨어", "개발", "개발자", "창업", "프론트엔드", "웹", "웹개발", "풀스택", "앱", "모바일"]
}
